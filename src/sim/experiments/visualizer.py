...
class ExperimentVisualizer:
    ...
    def plot_profit_by_strategy(self, df: pd.DataFrame) -> Optional[str]:
        ...
        fig = px.box(
            ...
            labels={"mean_profit_per_firm": "Mean Profit per Firm", "config_id": "Experiment ID"}
        )
    ...
    def plot_market_power(self, df: pd.DataFrame) -> Optional[str]:
        ...
        fig = px.scatter(
            ...
            labels={"avg_hhi": "Market Concentration (HHI)", "avg_price": "Average Market Price"}
        )
    ...
    def plot_cartel_dynamics(self, df: pd.DataFrame) -> Optional[str]:
        ...
        fig = px.bar(
            ...
            labels={"total_defections": "Mean Defections", "config_id": "Experiment ID"}
        )
