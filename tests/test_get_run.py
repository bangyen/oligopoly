...
# Test database setup
SQLALCHEMY_DATABASE_URL = "sqlite:///./test_get_run.db"
...
def test_get_run_bertrand_model(setup_database):
...
def test_get_run_large_simulation(setup_database):
...
def test_get_run_data_types(setup_database):
