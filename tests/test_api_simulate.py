...
def test_api_simulate_cournot(setup_database):
...
def test_api_simulate_bertrand(setup_database):
...
def test_api_simulate_invalid_model(setup_database):
...
def test_api_simulate_invalid_rounds(setup_database):
...
def test_api_simulate_no_firms(setup_database):
...
def test_persistence_counts(setup_database):
...
def test_get_run_valid_id(setup_database):
...
def test_get_run_invalid_id(setup_database):
...
def test_bertrand_simulation_results(setup_database):
